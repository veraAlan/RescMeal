...
export default (props: { profile: Role | null }) => {
   ...
   return (
      <div className='relative grid grid-cols-3 grid-flow-row w-full p-4 text-2xl border rounded-xl border-2'>
         ...
         <h3 className='w-full h-full rounded-xl font-semibold text-3xl text-center'>Tipo de Vehiculo: </h3>
         <h4 className='w-full h-full rounded-xl col-span-2 p-2 text-3xl text-center'>{props.profile?.vehicle_type}</h4>
