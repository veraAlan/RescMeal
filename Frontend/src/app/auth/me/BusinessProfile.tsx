   ...
   return (
      <div>
         <div className='relative grid grid-cols-3 grid-flow-row w-full p-4 text-2xl border rounded-xl border-2'>
            <h3 className='w-full h-full rounded-xl font-semibold text-3xl text-center'>Nombre de Local: </h3>
            <h4 className='w-full h-full rounded-xl col-span-2 p-2 text-3xl text-center'>{props.profile?.name}</h4>
            <h3 className='w-full h-full rounded-xl font-semibold text-3xl text-center'>Typo de Local: </h3>
            <h4 className='w-full h-full rounded-xl col-span-2 p-2 text-3xl text-center'>{props.profile?.type}</h4>
            <h3 className='w-full h-full rounded-xl font-semibold text-3xl text-center'>Direccion: </h3>
            <h4 className='w-full h-full rounded-xl col-span-2 p-2 text-3xl text-center'>{props.profile?.address}</h4>
            <h3 className='w-full h-full rounded-xl font-semibold text-3xl text-center'>Celular: </h3>
            <h4 className='w-full h-full rounded-xl col-span-2 p-2 text-3xl text-center'>{props.profile?.phone}</h4>
            <h3 className='w-full h-full rounded-xl font-semibold text-3xl text-center'>Horario: </h3>
            <h4 className='w-full h-full rounded-xl col-span-2 p-2 text-3xl text-center'>{props.profile?.schedule}</h4>
            <h3 className='w-full h-full rounded-xl font-semibold text-3xl text-center'>CVU: </h3>
            <h4 className='w-full h-full rounded-xl col-span-2 p-2 text-3xl text-center'>{props.profile?.cvu}</h4>
